...
```bash
# Clone and install
git clone <repo-url> && cd duplex-bot
uv sync
...
Open `http://localhost:8000/` in a browser, click **Connect**, and speak. The client captures microphone audio via Web Audio API and streams it to the server. You'll see your transcriptions and the agent's responses in the UI.
